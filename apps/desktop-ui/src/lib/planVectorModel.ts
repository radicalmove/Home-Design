...
const DESIGN_2_ADDED_FEATURES: PlanVectorFeature[] = [
  ...
  {
    id: "future_day_room_north_window",
    type: "window",
    renderGroup: "window",
    shape: {
      kind: "polygon",
  ...
  {
    id: "future_day_room_east_window",
    type: "window",
    renderGroup: "window",
    shape: {
      kind: "polygon",
  ...
  {
    id: "future_day_room_frosted_east_window",
    type: "window",
    renderGroup: "window",
    shape: {
      kind: "polygon",
  ...
  {
    id: "future_kitchen_day_room_opening",
    type: "opening",
    renderGroup: "opening",
    shape: {
      kind: "polygon",
  ...
  {
    id: "future_day_room_wide_opening",
    type: "opening",
    renderGroup: "opening",
    shape: {
      kind: "polygon",
