...
const BACK_SIDE_LIVING_TRANSITION: DesignStructuralTransition = {
  ...
  openings: [
    ...
    {
      id: "design-2-day-room-north-window",
      kind: "window",
      label: "day room deck-side window",
      x1: 914.0,
      y1: 489.1,
      x2: 950.6,
      y2: 489.1,
    ...
    {
      id: "design-2-day-room-east-window",
      kind: "window",
    ...
    {
      id: "design-2-day-room-frosted-east-window",
      kind: "window",
      label: "day room small east window",
      x1: 956.4,
      y1: 580.7,
      x2: 956.4,
      y2: 594.4,
    ...
    {
      id: "design-2-kitchen-day-room-opening",
      kind: "opening",
      label: "kitchen to day room opening",
      x1: 803.7,
      y1: 499.7,
      x2: 803.7,
      y2: 519.5,
    ...
    {
      id: "design-2-day-room-wide-opening",
      kind: "opening",
      label: "wide internal opening",
      x1: 803.7,
      y1: 523.3,
      x2: 902.8,
      y2: 523.3,
