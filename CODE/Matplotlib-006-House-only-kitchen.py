...
png_path = out_dir / "stylised_house_plan_v66_kitchen_window_lowered.png"
svg_path = out_dir / "stylised_house_plan_v66_kitchen_window_lowered.svg"
...
door = [P(822, 340), P(829, 340), P(829, 394), P(822, 394)]
ax.add_patch(Polygon(door, closed=True, facecolor=deck_door, edgecolor="#6e97ad",
                     linewidth=1.15, zorder=42))
ax.plot([P(825.5,340)[0], P(825.5,394)[0]], [P(825.5,340)[1], P(825.5,394)[1]],
...
add_label(P(782, 352), "Dining", 8.4, z=90)
...
ax.text((P(520,610)[0] + P(940,610)[0]) / 2, P(520,610)[1] - 0.45,
        "Stylised house plan v66 — kitchen window lowered",
