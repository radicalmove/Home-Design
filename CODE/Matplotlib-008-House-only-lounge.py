...
png_path = out_dir / "stylised_house_plan_v87_coffee_table_higher.png"
svg_path = out_dir / "stylised_house_plan_v87_coffee_table_higher.svg"
...
ax.text((P(520,610)[0] + P(940,610)[0]) / 2, P(520,610)[1] - 0.45,
        "Stylised house plan v87 — coffee table moved higher",
