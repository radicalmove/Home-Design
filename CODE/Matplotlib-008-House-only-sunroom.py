...
png_path = out_dir / "stylised_house_plan_v116_sunroom_table_tiny_more_right.png"
svg_path = out_dir / "stylised_house_plan_v116_sunroom_table_tiny_more_right.svg"
...
ax.text((P(520,610)[0] + P(940,610)[0]) / 2, P(520,610)[1] - 0.45,
        "Stylised house plan v116 — sunroom table tiny more right",
